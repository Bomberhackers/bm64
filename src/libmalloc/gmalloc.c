// As much as I do not want to modify this file, Hudson didnt use the libultra mem functions and
// instead seems to be pointing at their own functions. The rest of the file is unmodified.
#define memcpy hmemcpy
#define memmove hmemmove
#define memset hmemset
